...
import { Flame, Mail, Lock, User, Eye, EyeOff, ArrowRight, Sparkles, Shield, Zap } from "lucide-react"
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-5 sm:px-8 py-12 bg-[var(--color-background)]">
        ...
        >
          ...
          {/* Social */}
          <button className="w-full py-3 rounded-xl border border-[var(--color-border)] text-[13px] font-semibold hover:bg-[var(--color-secondary)] transition-all flex items-center justify-center gap-2.5">
